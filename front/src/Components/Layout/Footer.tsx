    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              ...
              make higher education accessible for everyone. Start your journey towards academic success today.
            </p>
            <div className="flex space-x-4">
              ...
              <div className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-cyan-400 transition-colors cursor-pointer">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-400 hover:text-cyan-300 transition-colors">info@scholarshiphub.edu</span>
              </div>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-cyan-900 bg-opacity-30 rounded-lg flex items-center justify-center mr-3">
                  <Phone className="w-5 h-5 text-cyan-400" />
                </div>
                <span className="text-gray-400 hover:text-cyan-300 transition-colors">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-start">
                <div className="w-10 h-10 bg-cyan-900 bg-opacity-30 rounded-lg flex items-center justify-center mr-3 mt-1">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© {new Date().getFullYear()} ScholarshipHub. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/cookies" className="text-gray-400 hover:text-cyan-300 transition-colors text-sm">
              Cookie Policy
            </Link>
          </div>
        </div>
